...
(function(global, factory) {
   ...
   */
    var setParameters = function(params) {
        ...
        modal.style.width = (typeof params.width === 'number')
            ? params.width + 'px'
            : params.width;
        ...
        var currentProgressStep = parseInt(params.currentProgressStep === null
            ? sweetAlert.getQueueStep()
            : params.currentProgressStep, 10);
        if (params.progressSteps.length) {
            show(progressStepsContainer);
            empty(progressStepsContainer);
            if (currentProgressStep >= params.progressSteps.length) {
                console.warn('SweetAlert2: Invalid currentProgressStep parameter, it should be less than progressSteps.length ' +
